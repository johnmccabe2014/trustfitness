...
const schedule = [
  ...
  { day: 'Monday', time: '07:30 AM', name: 'Bootcamp' },
  { day: 'Monday', time: '10:00 AM', name: 'Bootcamp' },
  { day: 'Monday', time: '06:00 PM', name: 'Bootcamp' },
  { day: 'Monday', time: '07:00 PM', name: 'Bootcamp' },
  { day: 'Tuesday', time: '10:00 AM', name: 'Revelate' },
  { day: 'Tuesday', time: '05:30 PM', name: 'Revelate' },
  { day: 'Tuesday', time: '06:30 PM', name: 'HYROX' },
  { day: 'Wednesday', time: '06:30 AM', name: 'Bootcamp' },
  { day: 'Wednesday', time: '07:30 AM', name: 'Bootcamp' },
  ...
  { day: 'Thursday', time: '10:00 AM', name: 'Revelate' },
  { day: 'Thursday', time: '05:30 PM', name: 'Revelate' },
  { day: 'Thursday', time: '06:30 PM', name: 'HYROX' },
  { day: 'Friday', time: '06:30 AM', name: 'Bootcamp' },
  { day: 'Friday', time: '07:30 AM', name: 'Bootcamp' },
